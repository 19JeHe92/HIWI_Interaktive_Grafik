...
(function (visualization) {
    ...
    var topLevelItem = {label: "Usability Engineering"};

    var subSubData = [
        {colorIndex: 10, value: 10, label: "Label 1"},
        {colorIndex: 11, value: 10, label: "Label 2"},
        {colorIndex: 12, value: 10, label: "Label 3"},
        {colorIndex: 13, value: 10, label: "Label 4"}
    ];

    var subData = [
        {colorIndex: 5, value: 10, label: "Methode 1"},
        {colorIndex: 6, value: 10, label: "Methode 2"},
        {colorIndex: 7, value: 10, label: "Methode 3"},
        {colorIndex: 9, value: 10, childData: subSubData, label: "Methode 4"}
    ];

    var data = [
        {colorIndex: 0, value: 10, childData: subData, label: "Analyse"},
        {colorIndex: 1, value: 10, childData: subData, label: "Konzeption"},
        {colorIndex: 2, value: 10, childData: subData, label: "Umsetzung"},
        {colorIndex: 3, value: 10, childData: subData, label: "Sammlung"}
    ];
